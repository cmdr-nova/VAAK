...
function ap_cmdr_shell_start(string $title, array $meta = []): void
{
    ...
    if (ap_cmdr_use_site_shell()) {
        ap_cmdr_site_shell_start($title, $meta);
        return;
    }
    ...
    echo '<style>
      ...
      .sl-link a:hover{border-color:#7ee0ff;background:#1a1a1a}
...
/** @param array<string,string> $meta */
function ap_cmdr_site_shell_start(string $title, array $meta = []): void
{
...
function ap_cmdr_html(): void
{
    ...
    $wowLink = function_exists('ap_wow_link_for_actor_key') ? ap_wow_link_for_actor_key('cmdr_nova') : null;
